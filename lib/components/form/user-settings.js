  ...
  render () {
    ...
    return (
      <div className='user-settings'>
        ...
        <hr />
        <div className='section-header'>Fermate preferite</div>
        <ul style={{ padding: 0 }}>
        ...
        {trackRecent && recentSearches.length > 0 &&
          <div className='recent-searches-container'>
            <hr />
            <div className='section-header'>Ricerche recenti</div>
            <ul style={{ padding: 0 }}>
              {recentSearches
        ...
        <div className='remember-settings'>
          <div className='section-header'>Le mie preferenze</div>
          <small>Ricordare luoghi e ricerche recenti?</small>
          <Button
            onClick={this._enableTracking}
            className={trackRecent ? 'active' : ''}
            bsSize='xsmall'
            bsStyle='link'>Sì</Button>
          <Button
