        ...
        <div className='stop-viewer-header'>
          ...
          {!hideBackButton && (
            <div className='back-button-container'>
              ...
              ><Icon type='arrow-left' />Indietro</Button>
            </div>
          )}
      ...
      <div className='route-row'>
        ...
        <div className='header'>
          ...
          <div className='route-name'>
            ...
            <b>{routeName}</b> Direzione {pattern.headsign}
            {/* </button> */}
          </div>
          ...
          {this.state.expanded && (
            <div>
              <div className='trip-table'>
                ...
                <div className='header'>
                  <div className='cell' />
                  <div className='cell time-column'>PARTENZA</div>
                  <div className='cell status-column'>STATO</div>
                </div>
  ...
  if (delay > 60) {
    return (
      <div className='status-label' style={{ backgroundColor: '#d9534f' }}>
        {formatDuration(delay)} in ritardo
      </div>
    )
  }
  ...
  if (delay < -60) {
    return (
      <div className='status-label' style={{ backgroundColor: '#337ab7' }}>
        {formatDuration(Math.abs(delay))} in anticipo
      </div>
    )
  }
