      ...
      <div className='trip-viewer'>
        ...
        <div className='trip-viewer-header'>
          ...
          <div className='header-text'>
            {languageConfig.tripViewer || 'Dettaglio Corsa'}
          </div>
        ...
        <div className='trip-viewer-body'>
          ...
          {tripData && (
            <div>
              {/* Route name */}
              <div>Linea: <b>{tripData.route.shortName}</b> {tripData.route.longName}</div>

              {/* Wheelchair/bike accessibility badges, if applicable */}
              <h4>
                {tripData.wheelchairAccessible === 1 &&
                  <Label bsStyle='primary'>
                    <Icon type='wheelchair-alt' /> Accessibile
                  </Label>
                }
                {' '}
                {tripData.bikesAllowed === 1 &&
                  <Label bsStyle='success'>
                    <Icon type='bicycle' /> Permessa
                  </Label>
                }
              </h4>
            </div>
              ...
              return (
                <div key={i}>
                  ...
                  <div className='stop-button-container'>
                    <ViewStopButton stopId={stop.id} text='Vedi' />
                  </div>
