      ...
      <div
        ...
        >
          ...
          <div className='route-name'>
            ...
            {leg.headsign && <div className='headsign'>Direzione {leg.headsign}</div>}
          </div>
            ...
            <div className='trip-details-row'>
              ...
              <div className='trip-details-cell'>
                ...
                <div className='intermediate-stops'>
                  <div>
                    ...
                    <button className='clear-button-formatting' onClick={this._onClick}>
                      ...
                      {' '}
                      ({numStops ? `${numStops} fermate` : 'non-stop'})
                    </button>
                ...
                <div className='item info-item'>
                  <span className='agency-info'>Servizio svolto da <a href={leg.agencyUrl}>{leg.agencyName}</a></span>
                  {
                    // route info included?
