    ...
    return (
      <div
        ...
        <button
          ...
          <span><b>{leg.mode === "WALK" ? "CAMMINA" : leg.mode}</b></span>
          {' '}
          <span className='leg-duration'>{coreUtils.time.formatDuration(leg.duration)}</span>
          {' '}
          <span className='leg-distance'>({humanizeDistanceStringMetric(leg.distance)})</span>
        </button>
        {active &&
              ...
              {leg.steps.map((step, stepIndex) => {
                ...
                return (
                  <button
                    ...
                    <span className='step-distance'>{humanizeDistanceStringMetric(step.distance)}</span>
